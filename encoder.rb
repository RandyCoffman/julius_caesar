require 'date' # This allows you to get the date from Ruby's built in Library
...
def reverse_caesar_cipher(string, shift = DateTime.now.day)
  string.tr Alphabet.join, Alphabet.map{ |array| array.rotate -shift }.join # This is like the same as in the above function, but this -shift will go backwards to reverse the encoded message basically
end
